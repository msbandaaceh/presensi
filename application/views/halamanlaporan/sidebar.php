    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                ...
                <?php
                if (in_array($page, ['laporan_harian', 'laporan_satker', 'laporan_apel', 'laporan_kegiatan'])) {
                    echo '<li class="active">';
                } else {
                    echo '<li>';
                }
                ...
                <ul class="ml-menu">
                    ...
                    if ($page == 'laporan_harian') {
                        echo '<li class="active">';
                        echo '<a>Laporan Harian</a>';
                    } else {
                        echo '<li>';
                        echo '<a href="' . site_url('laporan') . '">Laporan Harian</a>';
                    }
                    ?>
                    <?php
                    if (in_array($peran, ['admin', 'petugas'])) {
                        ...
                        if ($page == 'laporan_satker') {
                            echo '<li class="active">';
                            echo '<a>Laporan Satker</a>';
                        } else {
                            echo '<li>';
                            echo '<a href="' . site_url('laporan_satker') . '">Laporan Satker</a>';
                        }

                        if ($page == 'laporan_apel') {
                            echo '<li class="active">';
                            echo '<a>Laporan Presensi Apel</a>';
                        } else {
                            echo '<li>';
