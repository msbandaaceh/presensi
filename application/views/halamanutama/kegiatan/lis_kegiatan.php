...
<div class="modal fade" id="modalAddKegiatan" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content modal-col-orange">
            <form method="POST" id="formSM" action="<?php base_url() ?>simpan_kegiatan">
                            ...
                            <div class="col">
                                ...
                                <div class="form-line col-black">
                                    <input type="text" id="nama_kegiatan_" name="nama_kegiatan"
                                        class="form-control bg-orange" placeholder="Tuliskan lokasi rapat..">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="submit" id="btnSimpan" class="btn btn-link waves-effect">SIMPAN RAPAT</button>
